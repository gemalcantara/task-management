                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                                        <a href="{{ route('tasks.edit', $subtask->id) }}"
                                            class="btn task-action btn-outline-primary"><i
                                                class="bi bi-pencil-square"></i></a>
                                        <button type="button" class="btn task-action btn-outline-danger"
                                            data-bs-toggle="modal" data-bs-target="#deleteModal{{ $subtask->id }}">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="{{ route('tasks.destroy', $subtask->id) }}"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const taskCard = document.querySelector('.task-action');
